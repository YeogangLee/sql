...
데이터베이스 관련 회사
엔코아 : 오라클
ㄴ DB 컨설팅 업체 - 무서운 사람들이 있는 곳?
구글 기사, 이화식 사장의 일당 250만원 - 2003.04.01
지금은 많이 죽었어요 ...

엔코아 ==> 데이터모델링 1세대, 엔코아_부사장 + 대표 컨설턴트 몇 명 ... -> b2en
b2en ==> b2en 대표컨설턴트 : dbian -- 교육쪽에서 유명

컨설팅의 꿈 ... 접게 된 이유 - 스터디
엔코아 15년차 여성 개발자 ... 충대 경영학과
개발 5년 미만차들은 3시 이전에 잘 수가 없다
경험 이전의 간접체험, 나랑은 안 맞겠구나...
데이터 잘 다루는 개발자...
